      ...
      if (status.registered) {
        ...
        const upActionsBlock = (status.state === 'up' || status.state === 'window') ? `
          <div class="boss-card__register">
            ...
            <button class="btn-l2 flex-fill" data-action="clear-unknown" data-id="${boss.id}" data-bs-toggle="tooltip" title="No se sabe cuándo apareció/murió — vuelve a 'sin registrar'">
              <i class="fa-solid fa-user-secret"></i> Incógnito
            </button>
          </div>` : '';
